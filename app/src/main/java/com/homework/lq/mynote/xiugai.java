...
//                values.clear();
                ...
                values.put("time",BWtime);
                values.put("degree",key1);
                db.update("note",values,"id = ?",new String[]{d});
    ...
    protected void showDatePickDlg() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(xiugai.this, new OnDateSetListener() {

            @Override
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                monthOfYear =monthOfYear+1;
                String TmonthOfYear = String.format("%02d",monthOfYear);
                xiugai.this.mEditText.setText(year + "-" + TmonthOfYear + "-" + dayOfMonth);
            }
    ...
    protected void showTimePickDlg() {
        new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int hourofday, int minuteofhour) {
                hour=hourofday;
                minute=minuteofhour;
                xiugai.this.tEditText.setText(hour+"时"+minute+"分");
            }
        }, 15, 20, true).show();
    }
    /*设置数据源*/
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            ...
            myIntent = new Intent(xiugai.this, MainActivity.class);
